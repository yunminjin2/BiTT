...
def load_decoder(cfg, encoder_info):
    ...
    model = decoder(
        ...
        f_out_Dim=cfg.INTAGHANDMODEL.IMG_DIMS,
        gcn_in_dim=cfg.INTAGHANDMODEL.GCN_IN_DIM,
        gcn_out_dim=cfg.INTAGHANDMODEL.GCN_OUT_DIM,
        graph_k=cfg.INTAGHANDMODEL.graph_k,
        graph_layer_num=cfg.INTAGHANDMODEL.graph_layer_num,
        vertex_num=778,
